class Actions {
    ...
    fun readCommand() {
        print("Введите действие: 1. exit 2. help 3. add <Имя> phone <Номер телефона> 4. add <Имя> email <Адрес электронной почты> 5. show <Имя> 6. find <Номер телефона или Адрес электронной почты>: ")
